export default function AITherapy() {
  return (
    <section id="ai-support" className="py-24 px-6 bg-background-subtle overflow-hidden scroll-mt-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-8 text-sm text-foreground-muted italic">
              ...
              <a
                href="#crisis-support"
                className="text-secondary underline underline-offset-2 not-italic font-medium hover:text-primary-dark"
              >
                see UK crisis support
              </a>{" "}
          ...
          <div className="relative">
            <div className="rounded-3xl border border-border bg-surface p-6 shadow-sm max-w-sm mx-auto lg:ml-auto">
              <div className="flex items-center gap-3 mb-6 pb-4 border-b border-border">
                <div className="w-10 h-10 rounded-full bg-secondary-subtle flex items-center justify-center">
                  <svg className="w-5 h-5 text-secondary" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
            ...
            <div className="absolute -z-10 top-8 -right-8 w-72 h-72 rounded-full bg-secondary-subtle opacity-50 blur-3xl" aria-hidden="true" />
            <div className="absolute -z-10 bottom-8 -left-8 w-56 h-56 rounded-full bg-primary-subtle opacity-40 blur-3xl" aria-hidden="true" />
          </div>
        </div>
      </div>
    </section>
